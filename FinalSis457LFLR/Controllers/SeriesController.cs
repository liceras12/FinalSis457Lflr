...
using FinalSis457LFLR.Models;
using Microsoft.AspNetCore.Authorization;

namespace FinalSis457LFLR.Controllers
{
    //[Authorize]
    public class SeriesController : Controller
    {
        private readonly FinalSis457LflrContext _context;

        public SeriesController(FinalSis457LflrContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Sinopsis,Director,Duracion,FechaEstreno,UsuarioRegistro,RegistroActivo")] Serie serie)
        {
            ...
            {
                serie.usuarioRegistro = User.Identity.Name;
                _context.Add(serie);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalSis457LflrContext.Series'  is null.");
            }
            var serie = await _context.Series.FindAsync(id);
            if (serie != null)
            {
